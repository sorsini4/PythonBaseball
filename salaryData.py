...
ax.plot(athletics['yearID'], athletics['salary']/1000000, label = 'Athletics', color = OAKLAND_SECONDARY_COLOR, linewidth = 1.5)
...
ax.set_title('Money Spent by Yankees and A\'s', color = 'black')
